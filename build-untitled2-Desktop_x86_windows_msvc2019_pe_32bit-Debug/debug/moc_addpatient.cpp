...
#include <memory>
#include "../../untitled2/addpatient.h"
...
QT_MOC_LITERAL(3, 24, 15), // "on_add1_clicked"
QT_MOC_LITERAL(4, 40, 21) // "on_returnback_clicked"

    },
    "addpatient\0sentsignals\0\0on_add1_clicked\0"
...
void addpatient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&addpatient::sentsignals)) {
                *result = 0;
                return;
            }
        }
