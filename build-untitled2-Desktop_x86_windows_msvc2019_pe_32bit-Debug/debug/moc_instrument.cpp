...
#include <memory>
#include "../../untitled2/instrument.h"
...
QT_MOC_LITERAL(4, 46, 23) // "on_pushButton_2_clicked"
    ...
    "instrument\0sentsignals\0\0on_pushButton_clicked\0"
...
void instrument::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&instrument::sentsignals)) {
                *result = 0;
                return;
            }
        }
